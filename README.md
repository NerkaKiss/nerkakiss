...
End-to-end and API test automation for a real Lithuanian e-commerce site using **Playwright + TypeScript**.

**Key features:**
- Page Object Model architecture with `PageManager` + custom fixtures pattern
- UI + API testing with GraphQL cart validation
...
I'm always open to learning, collaborating, and improving automation practices.
